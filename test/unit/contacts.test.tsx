...
describe("Проверка карточки товара", () => {
    ...
    const application = (
        <MemoryRouter initialEntries={["/contacts"]} basename={basename}>
    ...
    it("По адресу '/contacts' открывается страница контактов", async () => {
        const { container } = render(application);
        const title = container.querySelector(".Contacts");
